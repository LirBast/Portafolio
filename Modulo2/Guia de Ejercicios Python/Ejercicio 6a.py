...
if tiene_mayus and tiene_minus and tiene_digit and passw_cantidad>=8:
    print("la palabra tiene al menos una letra mayuscula, una minuscula, al menos un digito y tiene al menos 8 caracteres")
    print("Es una contraseña Fuerte")
else:
    print("no cumple com las especificaciones")