...
print(f'\n Media de las medias muestrales {np.mean(medias_muestrales):.2f} gr')
print(f' Desviacion estandar de las medias muestrales (Error estandar) {np.std(medias_muestrales):.2f} gr')
print(f' Error Estandar Teorico de la media poblacional (SIGMA / SQRT(N)) {desv_poblacional/np.sqrt(tamano_muestra):.2f} gr')